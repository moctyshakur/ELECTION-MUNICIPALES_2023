...
<head>
  ...
  <title>Modification  Electeurs</title>
...
<body>
  <div class="container col-md-6 col-md-offset-3 spacer">
    <div class=" panel panel-info">
      <div class="panel-heading">Modification d'un Electeur</div>
      <div class="panel-body">
        
<form method="POST" action="../Validation/validationelecteurs.php">

  <div class="form-group">
  <label class="control-label">N°  </label>
  <input type="text" name="ID_ELECT" class="form-control" value="<?php echo $ligne[0]?>">
</div>
    <div class="form-group">
  <label class="control-label">N° Pièce d'Identité </label>
  <input type="text" name="identelecteurs" class="form-control" value="<?php echo $ligne[1]?>">
</div>

  <div class="form-group">
  <label class="control-label">Nom Complet </label>
  <input type="text" name="nometprenoms" class="form-control" value="<?php echo $ligne[2]?>">
</div>
  
<div class="form-group">
  <label class="control-label">Date de Naissance </label>
  <input type="date" name="datenaissance" class="form-control" value="<?php echo $ligne[3]?>">
</div>

<div class="form-group">
  <label class="control-label">Lieu de Naissance </label>
  <input type="text" name="lieunaissance" class="form-control" value="<?php echo $ligne[4]?>">
</div>

<div class="form-group">
  <label class="control-label">Quartier</label>
  <select class="form-control" name="quartier">
  <option value="" selected><?php echo $ligne[5]?></option>
  ...
  <option value="" selected><?php echo $ligne[6]?></option>
  ...
  <option value=">" selected><?php echo $ligne[7]?></option>
...
<div class="form-group">
  ...
  <input type="text" name="contact1" class="form-control" value="<?php echo $ligne[8]?>">
</div>

<div class="form-group">
  <label class="control-label">Contact 2 </label>
  <input type="text" name="contact2" class="form-control" value="<?php echo $ligne[9]?>">
</div>
<div class="form-group">
  <label class="control-label">ID PARRAIN </label>
  <input type="number" name="id_p" class="form-control" value="<?php echo $ligne[10]?>">
</div>


<div class="form-group">
<button class="btn btn-success" name="modif" type="submit">Enregistrer electeur</button>
